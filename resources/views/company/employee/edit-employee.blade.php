...
<section class="content">
   ...
   <div class="card card-primary">
      ...
      <form action="{{ route('company.update.employees', $employees->id) }}" method="post" enctype="multipart/form-data">
         @csrf 
         <div class="card-body">
            ...
            <div>
            @if(!empty($employees->image) && file_exists(public_path('uploads/company/employees/'.$employees->image)))
               <img src="{{ asset('public/uploads/company/employees/'.$employees->image) }}" width="150px" height="130px" alt="">
               @else
                    No Image Available
               @endif
              </div><br><br>
