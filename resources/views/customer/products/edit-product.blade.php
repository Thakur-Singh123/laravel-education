...
<section class="content">
   <div class="card card-primary">
      ...
      <div class="col-md-18 text-right">
         <a href="{{ url('customer/all-products-list') }}" class="btn btn-primary">All Products</a>
      </div>
      <div class="card-header">
         <h3 class="card-title">Edit Product</h3>
      </div>
      <form action="{{ route('customer.update.products', $products->id) }}" method="POST" enctype="multipart/form-data">
         @csrf 
         <div class="card-body">
            ...
            <div>
            @if(!empty($products->image) && file_exists(public_path('uploads/customer/products/images/'.$products->image)))
               <img src="{{ asset('public/uploads/customer/products/images/'.$products->image) }}" width="150px" height="130px" alt="">
               @endif
             </div>
            <div class="form-group">
