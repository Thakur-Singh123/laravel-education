...
<section class="content">
   ...
   <div class="card card-primary">
      ...
      <form action="{{route('admin.update.student', $teachers->id)}}" method="POST" enctype="multipart/form-data">
         @csrf 
         <div class="card-body">
         <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="text" name="phone" value="{{$teachers->phone}}" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <option value="active" @if($teachers->status == 'active') selected @endif>Active</option>
               <option value="pending" @if($teachers->status == 'pending') selected @endif>Pending</option>
               </select>
            </div>
